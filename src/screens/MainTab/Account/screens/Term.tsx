  ...
  return (
    <HomeLayout
      ...
      <ViewCus
        ...
        <TextCus>
          Ứng dụng GO Ber là một ứng dụng di động cung cấp dịch vụ sàn thương
        ...
        <TextCus>
          ...
          thức ăn sử dụng GO Ber để đăng thông báo về nhu cầu được sử dụng dịch
          vụ Đối tác giao hàng: là nhà cung cấp dịch vụ giao thực phẩm sử dụng
          GO Ber để kết nối đến khách hàng và nhà hàng
        </TextCus>
        <TextCus>
          Nhà hàng: là các cá nhân và tổ chức được đăng trên GO Ber, có hoặc
          không có nhu cầu quảng cáo và bán thực phẩm, là những người có thể
          cung cấp thực phẩm mà Khách hàng yêu cầu;
        </TextCus>
        <TextCus>
          Người dùng: Các cá nhân và tổ chức đăng ký để sử dụng ứng dụng GO Ber
        </TextCus>
        <TextCus>
