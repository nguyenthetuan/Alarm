...
export enum ENodata {
  ...
  NODATA_CAR = 'NODATA_CAR',
  NODATA_DRIVER = 'NODATA_DRIVER',
  NODATA_CARRENTAL = 'NODATA_CARRENTAL',
  NODATA_DELIVERYNATIONWIDE = 'NODATA_DELIVERYNATIONWIDE',
}
export const ICON_NO_DATA: Record<ENodata, string> = {
  [ENodata.NODATA_DELIVERYNATIONWIDE]: 'NODATA_DELIVERYNATIONWIDE',
  [ENodata.NODATA_CARRENTAL]: 'NODATA_CARRENTAL',
  [ENodata.NODATA_DRIVER]: 'NODATA_DRIVER',
  [ENodata.NODATA_CAR]: 'NODATA_CAR',
